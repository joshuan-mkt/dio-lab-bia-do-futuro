...
| Arquivo | Formato | Para que serve no Astri? |
|---------|---------|---------------------|
| `historico_atendimento.csv` | CSV | Contextualizar interações anteriores, ou seja, dar continuidade no entendimento de um aforma mais eficiente. |
| `perfil_investidor.json` | JSON | Personalizar explicações e dicas |
| `produtos_financeiros.json` | JSON | Conhecer e sugerir produtos adequados ao perfil do cliente |
...
O Fundo Multimercado foi substituído pelo Fundo Imobiliário (FII), pois já utilizei esses fundos e me sinto mais confiante em usar produtos financeiros que conheço. Assim poderei avaliar as respostas do Astri de forma mais acertiva.
---
